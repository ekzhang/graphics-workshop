  ...
  (function(global, factory) {
    ...
    function valueToModifier(elem, modifier) {
      return function(value) {
        applyClass(elem, className$n(void 0, modifier), value);
      };
    }
    ...
    var ValueMap = function() {
      function ValueMap2(initialValue) {
        ...
        this.valMap_ = keys.reduce(function(o, key, index) {
          var _a;
          return Object.assign(o, (_a = {}, _a[key] = props[index], _a));
        }, {});
      }
    ...
    var BladeController = function() {
        ...
        this.blade.emitter.on("change", function(ev) {
          if (ev.propertyName === "positions") {
            getAllBladePositions().forEach(function(pos) {
              elem.classList.remove(className$l(void 0, pos));
            });
            _this.blade.positions.forEach(function(pos) {
              elem.classList.add(className$l(void 0, pos));
            });
          }
        });
      ...
      BladeController2.prototype.onDispose = function() {
      };
    ...
    var LabeledView = function() {
      function LabeledView2(doc, config) {
        ...
        bindValueMap(config.props, "label", function(value) {
          if (isEmpty(value)) {
            _this.element.classList.add(className$k(void 0, "nol"));
          } else {
            _this.element.classList.remove(className$k(void 0, "nol"));
    ...
    var LabeledController = function(_super) {
      __extends(LabeledController2, _super);
      function LabeledController2(doc, config) {
        var _this = this;
      ...
      LabeledController2.prototype.onDispose = function() {
    ...
    var ListBladeApi = function(_super) {
      __extends(ListBladeApi2, _super);
      function ListBladeApi2(controller) {
      ...
      Object.defineProperty(ListBladeApi2.prototype, "label", {
        get: function() {
      ...
      Object.defineProperty(ListBladeApi2.prototype, "options", {
        get: function() {
      ...
      Object.defineProperty(ListBladeApi2.prototype, "value", {
        get: function() {
      ...
      ListBladeApi2.prototype.on = function(eventName, handler) {
    ...
    var ButtonController = function() {
      ...
      ButtonController2.prototype.click = function() {
    ...
    var MonitorBindingController = function(_super) {
      ...
      MonitorBindingController2.prototype.onDispose = function() {
    ...
    function createBladeApi(document, params) {
      var api = Plugins.blades.reduce(function(result, plugin) {
        return result || createApi(plugin, {
          document,
          params
        });
      }, null);
    ...
    var FolderApi = function(_super) {
      ...
      function FolderApi2(controller) {
        ...
        _this.apiSet_ = new NestedOrderedSet(function(api) {
          return api instanceof FolderApi2 ? api.apiSet_ : null;
        });
      ...
      Object.defineProperty(FolderApi2.prototype, "children", {
        get: function() {
          ...
          return this.controller_.bladeRack.children.map(function(bc) {
            var api = _this.apiSet_.find(function(api2) {
      ...
      FolderApi2.prototype.onRackRemove_ = function(ev) {
        var api = this.apiSet_.find(function(api2) {
          return api2.controller_ === ev.bladeController;
        });
        if (api) {
          this.apiSet_.remove(api);
        }
      };
      FolderApi2.prototype.onRackInputChange_ = function(ev) {
        var api = this.apiSet_.find(function(api2) {
          return api2 instanceof InputBindingApi ? api2.controller_ === ev.bindingController : false;
        });
        if (!api) {
          throw TpError.shouldNeverHappen();
        }
      ...
      FolderApi2.prototype.onRackMonitorUpdate_ = function(ev) {
        var api = this.apiSet_.find(function(api2) {
          return api2 instanceof MonitorBindingApi ? api2.controller_ === ev.bindingController : false;
        });
        if (!api) {
          throw TpError.shouldNeverHappen();
        }
      ...
      FolderApi2.prototype.onRackFolderFold_ = function(ev) {
        var api = this.apiSet_.find(function(api2) {
          return api2 instanceof FolderApi2 ? api2.controller_ === ev.folderController : false;
        });
        if (!api) {
          throw TpError.shouldNeverHappen();
        }
    ...
    var BladeRack = function() {
      ...
      BladeRack2.prototype.onChildDispose_ = function(_) {
        var _this = this;
      ...
      BladeRack2.prototype.onChildFolderFold_ = function(ev) {
        if (ev.propertyName !== "expanded") {
          return;
        }
      ...
      BladeRack2.prototype.onDescendantFolderFold_ = function(ev) {
        this.emitter.emit("folderfold", {
    ...
    var FolderController = function(_super) {
      ...
      FolderController2.prototype.onDispose = function() {
      ...
      FolderController2.prototype.applyRackChange_ = function() {
        var visibleItems = this.bladeRack.children.filter(function(bc) {
      ...
      FolderController2.prototype.onRackRemove_ = function(ev) {
        if (!ev.isRoot) {
          return;
        }
      ...
      FolderController2.prototype.onRackLayout_ = function(_) {
        this.applyRackChange_();
      };
    ...
    var RootApi = function(_super) {
      ...
      RootApi2.prototype.importPreset = function(preset) {
        var targets = this.controller_.bladeRack.find(InputBindingController).map(function(ibc) {
    ...
    var NumberTextView = function() {
      ...
      NumberTextView2.prototype.update_ = function() {
        var formatter = this.props_.get("formatter");
    ...
    var SliderBladeApi = function(_super) {
      __extends(SliderBladeApi2, _super);
      function SliderBladeApi2(controller) {
        var _this = _super.call(this, controller) || this;
        _this.emitter_ = new Emitter();
        _this.controller_.valueController.value.emitter.on("change", function(ev) {
          _this.emitter_.emit("change", {
      ...
      Object.defineProperty(SliderBladeApi2.prototype, "label", {
        get: function() {
          return this.controller_.props.get("label");
        },
        set: function(label) {
      ...
      Object.defineProperty(SliderBladeApi2.prototype, "maxValue", {
        get: function() {
      ...
      Object.defineProperty(SliderBladeApi2.prototype, "minValue", {
        get: function() {
      ...
      Object.defineProperty(SliderBladeApi2.prototype, "value", {
        get: function() {
          return this.controller_.valueController.value.rawValue;
        },
        set: function(value) {
      ...
      SliderBladeApi2.prototype.on = function(eventName, handler) {
        var bh = handler.bind(this);
        this.emitter_.on(eventName, function(ev) {
          bh(ev.event);
        });
    ...
    var TextView = function() {
      ...
      TextView2.prototype.update_ = function() {
        var formatter = this.props_.get("formatter");
    ...
    var TextBladeApi = function(_super) {
      __extends(TextBladeApi2, _super);
      function TextBladeApi2(controller) {
        var _this = _super.call(this, controller) || this;
        _this.emitter_ = new Emitter();
        _this.controller_.valueController.value.emitter.on("change", function(ev) {
          _this.emitter_.emit("change", {
      ...
      Object.defineProperty(TextBladeApi2.prototype, "label", {
        get: function() {
          return this.controller_.props.get("label");
        },
        set: function(label) {
      ...
      Object.defineProperty(TextBladeApi2.prototype, "formatter", {
        get: function() {
      ...
      Object.defineProperty(TextBladeApi2.prototype, "value", {
        get: function() {
          return this.controller_.valueController.value.rawValue;
        },
        set: function(value) {
      ...
      TextBladeApi2.prototype.on = function(eventName, handler) {
        var bh = handler.bind(this);
        this.emitter_.on(eventName, function(ev) {
          bh(ev.event);
        });
    ...
    var Tweakpane = function(_super) {
      __extends(Tweakpane2, _super);
      function Tweakpane2(opt_config) {
        var _a;
        var _this = this;
      ...
      Object.defineProperty(Tweakpane2.prototype, "document", {
        get: function() {
          if (!this.doc_) {
      ...
      Tweakpane2.prototype.dispose = function() {
      ...
      Tweakpane2.version = new Semver("2.3.0");
      return Tweakpane2;
    }(RootApi);
...
// dep:tweakpane
var tweakpane_default = require_tweakpane();
export {
  tweakpane_default as default
};
